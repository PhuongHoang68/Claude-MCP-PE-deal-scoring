...
"[project]/node_modules/@anthropic-ai/sdk/helpers/beta/mcp.mjs [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
function isSupportedResourceMimeType(mimeType) {
    return !mimeType || mimeType.startsWith('text/') || mimeType === 'application/pdf' || isSupportedImageType(mimeType);
}
    ...
    const runnableTool = {
        ...
        run: async (input)=>{
            ...
            if (result.isError) {
                ...
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$anthropic$2d$ai$2f$sdk$2f$lib$2f$tools$2f$ToolError$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ToolError"](content);
            }
            ...
            if (result.content.length === 0 && // Spec: "Structured content is returned as a JSON object in the structuredContent field of a result."
        ...
        [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$anthropic$2d$ai$2f$sdk$2f$lib$2f$stainless$2d$helper$2d$header$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SDK_HELPER_SYMBOL"]]: 'mcpTool'
    };
    return runnableTool;
}
...
function mcpMessage(mcpMessage, extraProps) {
    const message = {
        ...
        content: [
            mcpContent(mcpMessage.content, extraProps)
        ],
        [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$anthropic$2d$ai$2f$sdk$2f$lib$2f$stainless$2d$helper$2d$header$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SDK_HELPER_SYMBOL"]]: 'mcpMessage'
    };
    return message;
}
        ...
        case 'text':
            {
                const textBlock = {
                    ...
                    text: content.text,
                    ...extraProps,
                    [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$anthropic$2d$ai$2f$sdk$2f$lib$2f$stainless$2d$helper$2d$header$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SDK_HELPER_SYMBOL"]]: 'mcpContent'
                };
                return textBlock;
            }
        case 'image':
 ...
 */ function mcpResourceContentToContentBlock(resourceContent, extraProps, helperName = 'mcpResourceToContent') {
    ...
    if (mimeType && isSupportedImageType(mimeType)) {
        ...
        const imageBlock = {
            ...
            ...extraProps,
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$anthropic$2d$ai$2f$sdk$2f$lib$2f$stainless$2d$helper$2d$header$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SDK_HELPER_SYMBOL"]]: helperName
        };
        return imageBlock;
    }
 ...
 */ function bytesFromResource(resource) {
    if ('blob' in resource) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$anthropic$2d$ai$2f$sdk$2f$internal$2f$utils$2f$base64$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fromBase64"])(resource.blob);
    }
 ...
 */ function textSourceFromResource(resource) {
    const data = 'text' in resource ? resource.text : new TextDecoder().decode((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$anthropic$2d$ai$2f$sdk$2f$internal$2f$utils$2f$base64$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fromBase64"])(resource.blob));
    return {
        type: 'text',
        data,
...
function mcpResourceToFile(result) {
    ...
    file[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$anthropic$2d$ai$2f$sdk$2f$lib$2f$stainless$2d$helper$2d$header$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SDK_HELPER_SYMBOL"]] = 'mcpResourceToFile';
    return file;
}
}),
];

//# sourceMappingURL=node_modules_%40anthropic-ai_sdk_0z5xcsd._.js.map